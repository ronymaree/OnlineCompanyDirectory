        ...
        <div class="main-container">
            ...
            <header class="block">
                ...
                <ul class="header-menu horizontal-list">
                    <li>
                        <a class="header-menu-tab" href="companyprofile.php"><span class="icon entypo-cog scnd-font-color"></span>Profile</a>
                    </li>
                    <li>
                        <a class="header-menu-tab" href="companyprofile.php?page=companyrequest"><span class="icon fontawesome-user scnd-font-color"></span>Requests</a>
                        
                    </li>
                    <li>
                        <a class="header-menu-tab" href="companyprofile.php?page=quotes"><span class="icon fontawesome-envelope scnd-font-color"></span>Quotes</a>
            ...
            <div class="left-container container">
                <div class="profile block"> <!-- PROFILE (MIDDLE-CONTAINER) -->
                  ...
                  while($row = mysqli_fetch_assoc($result)){
                    ...
                    print '<p class="scnd-font-color">' .$row['address']. '</p>';
                    print '<a class="scnd-font-color" href="http://' .$row['website']. '">' .$row['website']. '</a>';
